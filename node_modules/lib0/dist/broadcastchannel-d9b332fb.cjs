...
class LocalStoragePolyfill {
  ...
  constructor (room) {
     ...
     */
    this.onmessage = null;
    addEventListener('storage', e => e.key === room && this.onmessage !== null && this.onmessage({ data: encoding.fromBase64(e.newValue || '') }));
  }
...
//# sourceMappingURL=broadcastchannel-d9b332fb.cjs.map
