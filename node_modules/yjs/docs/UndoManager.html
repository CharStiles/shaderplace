...
<head>
    <meta charset="utf-8">
    <title>Class: UndoManager | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>UndoManager<span class="signature">(typeScope, options)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>Fires 'stack-item-added' event when a stack item was added to either the undo- or
the redo-stack. You may store additional stack information via the
metadata property on <code>event.stackItem.meta</code> (it is a <code>Map</code> of metadata properties).
Fires 'stack-item-popped' event when a stack item was popped from either the
undo- or the redo-stack. You may restore the saved stack information from <code>event.stackItem.meta</code>.</p></div>
...
<dt>
        ...
        <h4 class="name" id="UndoManager">
            
                new <span class="type-signature"></span>UndoManager<span class="signature">(typeScope, options)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
                <code><a href="utils_UndoManager.js.html#line155">line 155</a></code>
            </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>typeScope</code></td>
...
<span class="param-type">Array.&lt;<a href="AbstractType.html">AbstractType</a>.&lt;any>></span>
            ...
            <td class="description last"><p>Accepts either a single type, or an array of types</p></td>
        </tr>
...
<span class="param-type"><a href="global.html#UndoManagerOptions">UndoManagerOptions</a></span>
...
<dl class="details">
    ...
    <ul>
        <li>Observable.&lt;('stack-item-added'|'stack-item-popped')></li>
    </ul>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="UndoManager.html">UndoManager</a>
                <div class="container-source members">
                    <code><a href="UndoManager.html">UndoManager</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="redoStack">
    <span class="type-signature"></span>redoStack<span class="type-signature"> :Array.&lt;<a href="StackItem.html">StackItem</a>></span>
    
    <div class="container-source members">
        <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
        <code><a href="utils_UndoManager.js.html#line173">line 173</a></code>
    </div>
...
<span class="param-type">Array.&lt;<a href="StackItem.html">StackItem</a>></span>
...
<dt>
<h4 class="name" id="undoing">
    <span class="type-signature"></span>undoing<span class="type-signature"> :boolean</span>
    
    <div class="container-source members">
        <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
        <code><a href="utils_UndoManager.js.html#line179">line 179</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Whether the client is currently undoing (calling UndoManager.undo)</p>
    </div>
...
<dt>
<h4 class="name" id="undoStack">
    <span class="type-signature"></span>undoStack<span class="type-signature"> :Array.&lt;<a href="StackItem.html">StackItem</a>></span>
    
    <div class="container-source members">
        <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
        <code><a href="utils_UndoManager.js.html#line169">line 169</a></code>
    </div>
...
<dt>
        ...
        <h4 class="name" id="redo">
                ...
                <span class="type-signature"></span>redo<span class="signature">()</span><span class="type-signature"> &rarr; <span class="icon green">nullable</span> {<a href="StackItem.html">StackItem</a>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
                <code><a href="utils_UndoManager.js.html#line286">line 286</a></code>
            </div>
...
<span class="param-type"><a href="StackItem.html">StackItem</a></span>





- <p>Returns StackItem if a change was applied</p>
...
<dt>
        ...
        <h4 class="name" id="stopCapturing">
            
                <span class="type-signature"></span>stopCapturing<span class="signature">()</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
                <code><a href="utils_UndoManager.js.html#line261">line 261</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>UndoManager merges Undo-StackItem if they are created within time-gap
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>// without stopCapturing
    ytext.insert(0, 'a')
    ytext.insert(1, 'b')
    um.undo()
    ...
    ytext.insert(0, 'b')
    um.undo()
    ytext.toString() // => 'a' (note that only 'b' was removed)</code></pre>
...
<dt>
        ...
        <h4 class="name" id="undo">
                ...
                <span class="type-signature"></span>undo<span class="signature">()</span><span class="type-signature"> &rarr; <span class="icon green">nullable</span> {<a href="StackItem.html">StackItem</a>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_UndoManager.js.html">utils/UndoManager.js</a></code>,
                <code><a href="utils_UndoManager.js.html#line270">line 270</a></code>
            </div>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'UndoManager_sub'.replace(/"/g, '_');
