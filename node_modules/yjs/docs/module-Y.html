...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="module-Y.Doc.html">Doc</a>
                <div class="container-source members">
                    <code><a href="module-Y.Doc.html">module:Y.Doc</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="~DocOpts">
    DocOpts
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line23">line 23</a></code>
    </div>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>DocOpts.gc</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Disable garbage collection (default: gc=true)</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>DocOpts.gcFilter</code></td>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>Will be called before an Item is garbage collected. Return false to keep the Item.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>DocOpts.guid</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Define a globally unique identifier for this document</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>DocOpts.meta</code></td>
...
<span class="param-type">any</span>
            ...
            <td class="description last"><p>Any kind of meta information you want to associate with this document. If this is a subdocument, remote peers will store the meta information as well.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>DocOpts.autoLoad</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If a subdocument, automatically load document. If this is a subdocument, remote peers will load the document as well automatically.</p></td>
        </tr>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:Y_sub'.replace(/"/g, '_');
