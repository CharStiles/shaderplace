...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ID<span class="signature">(client, clock)</span><span class="type-signature"></span></h2>
...
<dt>
        ...
        <h4 class="name" id="ID">
                ...
                new <span class="type-signature"></span>ID<span class="signature">(client, clock)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_ID.js.html">utils/ID.js</a></code>,
                <code><a href="utils_ID.js.html#line13">line 13</a></code>
            </div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>client id</p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>unique per client id, continuous number</p></td>
        </tr>
