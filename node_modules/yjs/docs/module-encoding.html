...
<head>
    <meta charset="utf-8">
    <title>Module: encoding | yjs</title>
...
<dt>
        ...
        <h4 class="name" id=".applyUpdate">
            
                <span class="type-signature"><span class="icon green">static</span> </span>applyUpdate<span class="signature">(ydoc, update, transactionOrigin<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line478">line 478</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Apply a document update created by, for example, <code>y.on('update', update =&gt; ..)</code> or <code>update = encodeStateAsUpdate()</code>.</p>
<p>This function has the same effect as <code>readUpdate</code> but accepts an Uint8Array instead of a Decoder.</p>
    </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>ydoc</code></td>
...
<span class="param-type">Uint8Array</span>
        ...
        <tr>
                ...
                <td class="name"><code>transactionOrigin</code></td>
...
<span class="param-type">any</span>
            ...
            <td class="description last"><p>This will be stored on <code>transaction.origin</code> and <code>.on('update', (update, origin))</code></p></td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id=".applyUpdateV2">
            
                <span class="type-signature"><span class="icon green">static</span> </span>applyUpdateV2<span class="signature">(ydoc, update, transactionOrigin<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line462">line 462</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id=".decodeStateVector">
            
                <span class="type-signature"><span class="icon green">static</span> </span>decodeStateVector<span class="signature">(decodedState)</span><span class="type-signature"> &rarr; {Map.&lt;number, number>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line565">line 565</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Read decodedState and return State as Map.</p>
    </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>decodedState</code></td>
...
- <p>Maps <code>client</code> to the number next expected <code>clock</code> from that client.</p>
...
<dt>
        ...
        <h4 class="name" id=".decodeStateVectorV2">
            
                <span class="type-signature"><span class="icon green">static</span> </span>decodeStateVectorV2<span class="signature">(decodedState)</span><span class="type-signature"> &rarr; {Map.&lt;number, number>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line555">line 555</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id=".encodeStateAsUpdate">
            
                <span class="type-signature"><span class="icon green">static</span> </span>encodeStateAsUpdate<span class="signature">(doc, encodedTargetStateVector<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Uint8Array}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line526">line 526</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Write all the document as a single update message that can be applied on the remote document. If you specify the state of the remote client (<code>targetState</code>) it will
only write the operations that are missing.</p>
<p>Use <code>writeStateAsUpdate</code> instead if you are working with lib0/encoding.js#Encoder</p>
    </div>
...
<span class="param-type">Doc</span>
        ...
        <tr>
                ...
                <td class="name"><code>encodedTargetStateVector</code></td>
...
<span class="param-type">Uint8Array</span>
            ...
            <td class="description last"><p>The state of the target that receives the update. Leave empty to write all known structs</p></td>
        </tr>
...
<dt>
        ...
        <h4 class="name" id=".encodeStateAsUpdateV2">
            
                <span class="type-signature"><span class="icon green">static</span> </span>encodeStateAsUpdateV2<span class="signature">(doc, encodedTargetStateVector<span class="signature-attributes">opt</span>, encoder<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Uint8Array}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line508">line 508</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id=".encodeStateVector">
            
                <span class="type-signature"><span class="icon green">static</span> </span>encodeStateVector<span class="signature">(doc)</span><span class="type-signature"> &rarr; {Uint8Array}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line611">line 611</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Encode State as Uint8Array.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id=".encodeStateVectorV2">
            
                <span class="type-signature"><span class="icon green">static</span> </span>encodeStateVectorV2<span class="signature">(doc, encoder<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Uint8Array}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line598">line 598</a></code>
            </div>
...
<span class="param-type"><a href="AbstractDSEncoder.html">AbstractDSEncoder</a></span>
...
<dt>
        ...
        <h4 class="name" id=".readStateVector">
            
                <span class="type-signature"><span class="icon green">static</span> </span>readStateVector<span class="signature">(decoder)</span><span class="type-signature"> &rarr; {Map.&lt;number, number>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line536">line 536</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Read state vector from Decoder and return as Map</p>
    </div>
...
<span class="param-type"><a href="AbstractDSDecoder.html">AbstractDSDecoder</a></span>
...
<dt>
        ...
        <h4 class="name" id=".readUpdate">
            
                <span class="type-signature"><span class="icon green">static</span> </span>readUpdate<span class="signature">(decoder, ydoc, transactionOrigin<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line448">line 448</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Read and apply a document update.</p>
<p>This function has the same effect as <code>applyUpdate</code> but accepts an decoder.</p>
    </div>
...
<span class="param-type">decoding.Decoder</span>
...
<dt>
        ...
        <h4 class="name" id=".readUpdateV2">
            
                <span class="type-signature"><span class="icon green">static</span> </span>readUpdateV2<span class="signature">(decoder, ydoc, transactionOrigin<span class="signature-attributes">opt</span>, structDecoder<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line431">line 431</a></code>
            </div>
...
<span class="param-type">any</span>
        ...
        <tr>
                ...
                <td class="name"><code>structDecoder</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="AbstractUpdateDecoder.html">AbstractUpdateDecoder</a></span>
...
<dt>
        ...
        <h4 class="name" id=".writeDocumentStateVector">
            
                <span class="type-signature"><span class="icon green">static</span> </span>writeDocumentStateVector<span class="signature">(encoder, doc)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line587">line 587</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id=".writeStateAsUpdate">
            
                <span class="type-signature"><span class="icon green">static</span> </span>writeStateAsUpdate<span class="signature">(encoder, doc, targetStateVector<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line490">line 490</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Write all the document as a single update message. If you specify the state of the remote client (<code>targetStateVector</code>) it will
only write the operations that are missing.</p>
    </div>
...
<span class="param-type">Doc</span>
        ...
        <tr>
                ...
                <td class="name"><code>targetStateVector</code></td>
...
<dt>
        ...
        <h4 class="name" id=".writeStateVector">
            
                <span class="type-signature"><span class="icon green">static</span> </span>writeStateVector<span class="signature">(encoder, sv)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line572">line 572</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="~cleanupPendingStructs">
            
                <span class="type-signature"><span class="icon green">inner</span> </span>cleanupPendingStructs<span class="signature">(pendingClientsStructRefs)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line375">line 375</a></code>
            </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>pendingClientsStructRefs</code></td>
            

            <td class="type">
            
                
<span class="param-type">Map.&lt;number, {refs:Array.&lt;(<a href="GC.html">GC</a>|<a href="Item.html">Item</a>)>, i:number}></span>
...
<dt>
        ...
        <h4 class="name" id="~writeStructs">
            
                <span class="type-signature"><span class="icon green">inner</span> </span>writeStructs<span class="signature">(encoder, structs, client, clock)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_encoding.js.html">utils/encoding.js</a></code>,
                <code><a href="utils_encoding.js.html#line71">line 71</a></code>
            </div>
...
<span class="param-type">Array.&lt;(<a href="GC.html">GC</a>|<a href="Item.html">Item</a>)></span>
            ...
            <td class="description last"><p>All structs by <code>client</code></p></td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>write structs starting with <code>ID(client,clock)</code></p></td>
        </tr>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:encoding_sub'.replace(/"/g, '_');
