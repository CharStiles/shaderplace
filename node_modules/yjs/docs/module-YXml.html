...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="module-YXml.YXmlFragment.html">YXmlFragment</a>
                <div class="container-source members">
                    <code><a href="module-YXml.YXmlFragment.html">module:YXml.YXmlFragment</a></code>
                </div>
            </h4>
        </dt>
        ...
        <dt>
            <h4 class="name">
                <a href="module-YXml.YXmlTreeWalker.html">YXmlTreeWalker</a>
                <div class="container-source members">
                    <code><a href="module-YXml.YXmlTreeWalker.html">module:YXml.YXmlTreeWalker</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="~CSS_Selector">
    CSS_Selector
    
    <div class="container-source members">
        <code><a href="types_YXmlFragment.js.html">types/YXmlFragment.js</a></code>,
        <code><a href="types_YXmlFragment.js.html#line25">line 25</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Define the elements to which a set of CSS queries apply.
<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Selectors">CSS_Selectors</a></p>
    </div>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>query = '.classSelector'
  query = 'nodeSelector'
  query = '#idSelector'</code></pre>
...
<dt>
        ...
        <h4 class="name" id="~domFilter">
            
                <span class="type-signature"></span>domFilter<span class="signature">(nodeName, attributes)</span><span class="type-signature"> &rarr; {boolean}</span>
                
            
            <div class="container-source members">
                <code><a href="types_YXmlFragment.js.html">types/YXmlFragment.js</a></code>,
                <code><a href="types_YXmlFragment.js.html#line37">line 37</a></code>
            </div>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The nodeName of the element</p></td>
        </tr>
...
<span class="param-type">Map</span>
            ...
            <td class="description last"><p>The map of attributes.</p></td>
        </tr>
...
- <p>Whether to include the Dom node in the YXmlElement.</p>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:YXml_sub'.replace(/"/g, '_');
