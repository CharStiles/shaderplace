...
<head>
    <meta charset="utf-8">
    <title>Class: AbstractConnector | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AbstractConnector<span class="signature">(ydoc, awareness)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>This is an abstract interface that all Connectors should implement to keep them interchangeable.</p></div>
...
<dt>
        ...
        <h4 class="name" id="AbstractConnector">
            
                new <span class="type-signature"></span>AbstractConnector<span class="signature">(ydoc, awareness)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_AbstractConnector.js.html">utils/AbstractConnector.js</a></code>,
                <code><a href="utils_AbstractConnector.js.html#line16">line 16</a></code>
            </div>
...
<span class="param-type">Doc</span>
        ...
        <tr>
                ...
                <td class="name"><code>awareness</code></td>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="AbstractConnector.html">AbstractConnector</a>
                <div class="container-source members">
                    <code><a href="AbstractConnector.html">AbstractConnector</a></code>
                </div>
            </h4>
        </dt>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'AbstractConnector_sub'.replace(/"/g, '_');
