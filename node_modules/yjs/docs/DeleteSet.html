...
<head>
    <meta charset="utf-8">
    <title>Class: DeleteSet | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteSet<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>We no longer maintain a DeleteStore. DeleteSet is a temporary object that is created when needed.</p>
<ul>
<li>When created in a transaction, it must only be accessed after sorting, and merging
<ul>
<li>This DeleteSet is send to other clients</li>
</ul>
</li>
<li>We do not create a DeleteSet when we send a sync message. The DeleteSet message is created directly from StructStore</li>
<li>We read a DeleteSet as part of a sync/update message. In this case the DeleteSet is already sorted and merged.</li>
</ul></div>
...
<dt>
        ...
        <h4 class="name" id="DeleteSet">
                ...
                new <span class="type-signature"></span>DeleteSet<span class="signature">()</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_DeleteSet.js.html">utils/DeleteSet.js</a></code>,
                <code><a href="utils_DeleteSet.js.html#line40">line 40</a></code>
            </div>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="DeleteSet.html">DeleteSet</a>
                <div class="container-source members">
                    <code><a href="DeleteSet.html">DeleteSet</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="clients">
    <span class="type-signature"></span>clients<span class="type-signature"> :Map.&lt;number, Array.&lt;<a href="DeleteItem.html">DeleteItem</a>>></span>
    
    <div class="container-source members">
        <code><a href="utils_DeleteSet.js.html">utils/DeleteSet.js</a></code>,
        <code><a href="utils_DeleteSet.js.html#line45">line 45</a></code>
    </div>
...
<span class="param-type">Map.&lt;number, Array.&lt;<a href="DeleteItem.html">DeleteItem</a>>></span>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'DeleteSet_sub'.replace(/"/g, '_');
