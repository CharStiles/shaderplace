...
<head>
    <meta charset="utf-8">
    <title>Class: YXmlEvent | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>YXmlEvent<span class="signature">(target, subs, transaction)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>An Event that describes changes on a YXml Element or Yxml Fragment</p></div>
...
<dt>
        ...
        <h4 class="name" id="YXmlEvent">
            
                new <span class="type-signature"></span>YXmlEvent<span class="signature">(target, subs, transaction)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="types_YXmlEvent.js.html">types/YXmlEvent.js</a></code>,
                <code><a href="types_YXmlEvent.js.html#line10">line 10</a></code>
            </div>
...
<span class="param-type">YXmlFragment</span>
            ...
            <td class="description last"><p>The target on which the event is created.</p></td>
        </tr>
...
<span class="param-type">Set.&lt;(string|null)></span>
            ...
            <td class="description last"><p>The set of changed attributes. <code>null</code> is included if the
child list changed.</p></td>
        </tr>
...
<span class="param-type"><a href="Transaction.html">Transaction</a></span>
            ...
            <td class="description last"><p>The transaction instance with wich the
change was created.</p></td>
        </tr>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="YXmlEvent.html">YXmlEvent</a>
                <div class="container-source members">
                    <code><a href="YXmlEvent.html">YXmlEvent</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="attributesChanged">
    <span class="type-signature"></span>attributesChanged<span class="type-signature"> :Set.&lt;string></span>
    
    <div class="container-source members">
        <code><a href="types_YXmlEvent.js.html">types/YXmlEvent.js</a></code>,
        <code><a href="types_YXmlEvent.js.html#line30">line 30</a></code>
    </div>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'YXmlEvent_sub'.replace(/"/g, '_');
