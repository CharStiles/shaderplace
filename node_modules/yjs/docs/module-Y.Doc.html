...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-Y.html">Y</a>.</span>Doc<span class="signature">(opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A Yjs instance handles the state of shared data.</p></div>
...
<dt>
        ...
        <h4 class="name" id="Doc">
                ...
                new <span class="type-signature"></span>Doc<span class="signature">(opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line36">line 36</a></code>
            </div>
...
<span class="param-type">DocOpts</span>
...
<dt>
<h4 class="name" id="_item">
    <span class="type-signature"><span class="icon green">nullable</span> </span>_item<span class="type-signature"> :<a href="Item.html">Item</a></span>
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line67">line 67</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>If this document is a subdocument - a document integrated into another document - then _item is defined.</p>
    </div>
...
<dt>
<h4 class="name" id="_transaction">
    <span class="type-signature"></span>_transaction<span class="type-signature"> :<a href="Transaction.html">Transaction</a>|null</span>
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line54">line 54</a></code>
    </div>
...
<dt>
<h4 class="name" id="_transactionCleanups">
    <span class="type-signature"></span>_transactionCleanups<span class="type-signature"> :Array.&lt;<a href="Transaction.html">Transaction</a>></span>
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line58">line 58</a></code>
    </div>
...
<span class="param-type">Array.&lt;<a href="Transaction.html">Transaction</a>></span>
...
<dt>
<h4 class="name" id="share">
    <span class="type-signature"></span>share<span class="type-signature"> :Map.&lt;string, <a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>></span>
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line49">line 49</a></code>
    </div>
...
<span class="param-type">Map.&lt;string, <a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>></span>
...
<dt>
<h4 class="name" id="subdocs">
    <span class="type-signature"></span>subdocs<span class="type-signature"> :Set.&lt;Doc></span>
    
    <div class="container-source members">
        <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
        <code><a href="utils_Doc.js.html#line62">line 62</a></code>
    </div>
...
<span class="param-type">Set.&lt;Doc></span>
...
<dt>
        ...
        <h4 class="name" id="destroy">
            ...
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line242">line 242</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Emit <code>destroy</code> event and unregister all event handlers.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="get">
                ...
                <span class="type-signature"></span>get<span class="signature">(name, TypeConstructor)</span><span class="type-signature"> &rarr; {<a href="AbstractType.html">AbstractType</a>.&lt;any>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line139">line 139</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Define a shared data type.</p>
<p>Multiple calls of <code>y.get(name, TypeConstructor)</code> yield the same result
and do not overwrite each other. I.e.
<code>y.define(name, Y.Array) === y.define(name, Y.Array)</code></p>
<p>After this method is called, the type is also available on <code>y.share.get(name)</code>.</p>
<p><em>Best Practices:</em>
Define all types right after the Yjs instance is created and store them in a separate object.
Also use the typed methods <code>getText(name)</code>, <code>getArray(name)</code>, ..</p>
    </div>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>The constructor of the type definition. E.g. Y.Text, Y.Array, Y.Map, ...</p></td>
        </tr>
...
- <p>The created type. Constructed with TypeConstructor</p>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const y = new Y(..)
  const appState = {
...
<dt>
        ...
        <h4 class="name" id="getArray">
            
                <span class="type-signature"></span>getArray<span class="signature">(name<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {YArray.&lt;T>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line180">line 180</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="getMap">
                ...
                <span class="type-signature"></span>getMap<span class="signature">(name<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {YMap.&lt;any>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line202">line 202</a></code>
            </div>
...
<span class="param-type">YMap.&lt;any></span>
...
<dt>
        ...
        <h4 class="name" id="getText">
                ...
                <span class="type-signature"></span>getText<span class="signature">(name<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {YText}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line191">line 191</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="getXmlFragment">
            
                <span class="type-signature"></span>getXmlFragment<span class="signature">(name<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {YXmlFragment}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line213">line 213</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="load">
                ...
                <span class="type-signature"></span>load<span class="signature">()</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line80">line 80</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Notify the parent document that you request to load data into this subdocument (if it is a subdocument).</p>
<p><code>load()</code> might be used in the future to request any provider to load the most current data.</p>
<p>It is safe to call <code>load()</code> multiple times.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="off">
                ...
                <span class="type-signature"></span>off<span class="signature">(eventName, f)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line279">line 279</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="on">
                ...
                <span class="type-signature"></span>on<span class="signature">(eventName, f)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line271">line 271</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="toJSON">
                ...
                <span class="type-signature"></span>toJSON<span class="signature">()</span><span class="type-signature"> &rarr; {Object.&lt;string, any>}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line226">line 226</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Converts the entire document into a js object, recursively traversing each yjs type
Doesn't log types that have not been defined (using ydoc.getType(..)).</p>
    </div>
...
<dl class="details">
        ...
        <dt class="important tag-deprecated">Deprecated:</dt><dd><ul class="dummy"><li>Do not use this method and rather call toJSON directly on the shared types.</li></ul></dd>
...
<dt>
        ...
        <h4 class="name" id="transact">
            
                <span class="type-signature"></span>transact<span class="signature">(f, origin<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Doc.js.html">utils/Doc.js</a></code>,
                <code><a href="utils_Doc.js.html#line109">line 109</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Changes that happen inside of a transaction are bundled. This means that
the observer fires <em>after</em> the transaction is finished and that all changes
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>The function that should be executed as a transaction</p></td>
        </tr>
...
<span class="param-type">any</span>
            ...
            <td class="description last"><p>Origin of who started the transaction. Will be stored on transaction.origin</p></td>
        </tr>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:Y.Doc_sub'.replace(/"/g, '_');
