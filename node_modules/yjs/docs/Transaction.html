...
<head>
    <meta charset="utf-8">
    <title>Class: Transaction | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Transaction<span class="signature">(doc, origin, local)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A transaction is created for every change on the Yjs model. It is possible
to bundle changes on the Yjs model in a single transaction to
minimize the number on messages sent and the number of observer calls.
If possible the user of this library should bundle as many changes as
possible. Here is an example to illustrate the advantages of bundling:</p></div>
...
<dt>
        ...
        <h4 class="name" id="Transaction">
                ...
                new <span class="type-signature"></span>Transaction<span class="signature">(doc, origin, local)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
                <code><a href="utils_Transaction.js.html#line47">line 47</a></code>
            </div>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const map = y.define('map', YMap)
...
<dl>
        ...
        <dt>
            <h4 class="name">
                ...
                <div class="container-source members">
                    <code><a href="Transaction.html">Transaction</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="_mergeStructs">
    <span class="type-signature"></span>_mergeStructs<span class="type-signature"> :Array.&lt;<a href="AbstractStruct.html">AbstractStruct</a>></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line90">line 90</a></code>
    </div>
...
<span class="param-type">Array.&lt;<a href="AbstractStruct.html">AbstractStruct</a>></span>
...
<dt>
<h4 class="name" id="afterState">
    <span class="type-signature"></span>afterState<span class="type-signature"> :Map.&lt;Number, Number></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line73">line 73</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Holds the state after the transaction.</p>
    </div>
...
<dt>
<h4 class="name" id="beforeState">
    <span class="type-signature"></span>beforeState<span class="type-signature"> :Map.&lt;Number, Number></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line68">line 68</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Holds the state before the transaction started.</p>
    </div>
...
<h4 class="name" id="changed">
    <span class="type-signature"></span>changed<span class="type-signature"> :Map.&lt;<a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>, Set.&lt;(String|null)>></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line80">line 80</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>All types that were directly modified (property added or child
inserted/deleted). New types are not included in this Set.
Maps from type to parentSubs (<code>item.parentSub = null</code> for YArray)</p>
    </div>
...
<span class="param-type">Map.&lt;<a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>, Set.&lt;(String|null)>></span>
...
<dt>
<h4 class="name" id="changedParentTypes">
    <span class="type-signature"></span>changedParentTypes<span class="type-signature"> :Map.&lt;<a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>, Array.&lt;<a href="YEvent.html">YEvent</a>>></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line86">line 86</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Stores the events for the types that observe also child elements.
...
<span class="param-type">Map.&lt;<a href="AbstractType.html">AbstractType</a>.&lt;<a href="YEvent.html">YEvent</a>>, Array.&lt;<a href="YEvent.html">YEvent</a>>></span>
...
<dt>
<h4 class="name" id="deleteSet">
    <span class="type-signature"></span>deleteSet<span class="type-signature"> :<a href="DeleteSet.html">DeleteSet</a></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line63">line 63</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Describes the set of deleted items by ids</p>
    </div>
...
<span class="param-type"><a href="DeleteSet.html">DeleteSet</a></span>
...
<h4 class="name" id="doc">
    ...
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line58">line 58</a></code>
    </div>
...
<dt>
<h4 class="name" id="local">
    <span class="type-signature"></span>local<span class="type-signature"> :boolean</span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line104">line 104</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Whether this change originates from this doc.</p>
    </div>
...
<h4 class="name" id="meta">
    <span class="type-signature"></span>meta<span class="type-signature"> :Map.&lt;any, any></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line99">line 99</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Stores meta information on the transaction</p>
    </div>
...
<span class="param-type">Map.&lt;any, any></span>
...
<h4 class="name" id="origin">
    <span class="type-signature"></span>origin<span class="type-signature"> :any</span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line94">line 94</a></code>
    </div>
...
<dt>
<h4 class="name" id="subdocsAdded">
    <span class="type-signature"></span>subdocsAdded<span class="type-signature"> :Set.&lt;Doc></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line108">line 108</a></code>
    </div>
...
<dt>
<h4 class="name" id="subdocsLoaded">
    <span class="type-signature"></span>subdocsLoaded<span class="type-signature"> :Set.&lt;Doc></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line116">line 116</a></code>
    </div>
...
<dt>
<h4 class="name" id="subdocsRemoved">
    <span class="type-signature"></span>subdocsRemoved<span class="type-signature"> :Set.&lt;Doc></span>
    
    <div class="container-source members">
        <code><a href="utils_Transaction.js.html">utils/Transaction.js</a></code>,
        <code><a href="utils_Transaction.js.html#line112">line 112</a></code>
    </div>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'Transaction_sub'.replace(/"/g, '_');
