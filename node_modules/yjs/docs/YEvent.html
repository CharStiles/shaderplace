...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>YEvent<span class="signature">(target, transaction)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>YEvent describes the changes on a YType.</p></div>
...
<dt>
        ...
        <h4 class="name" id="YEvent">
            
                new <span class="type-signature"></span>YEvent<span class="signature">(target, transaction)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
                <code><a href="utils_YEvent.js.html#line13">line 13</a></code>
            </div>
...
<span class="param-type"><a href="AbstractType.html">AbstractType</a>.&lt;any></span>
            ...
            <td class="description last"><p>The changed type.</p></td>
        </tr>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="YEvent.html">YEvent</a>
                <div class="container-source members">
                    <code><a href="YEvent.html">YEvent</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
<h4 class="name" id="_changes">
    <span class="type-signature"></span>_changes<span class="type-signature"> :Object|null</span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line37">line 37</a></code>
    </div>
...
<h4 class="name" id="changes">
    <span class="type-signature"></span>changes<span class="type-signature"></span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line85">line 85</a></code>
    </div>
...
<dt>
<h4 class="name" id="currentTarget">
    <span class="type-signature"></span>currentTarget<span class="type-signature"> :<a href="AbstractType.html">AbstractType</a>.&lt;any></span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line28">line 28</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The current target on which the observe callback is called.</p>
    </div>
...
<h4 class="name" id="path">
    <span class="type-signature"></span>path<span class="type-signature"></span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line53">line 53</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Computes the path from <code>y</code> to the changed type.</p>
    </div>
...
<dl class="details">
    ...
    <dd class="tag-todo">
        <ul>
            <li>v14 should standardize on path: Array<{parent, index}> because that is easier to work with.

The following property holds:</li>
        </ul>
    </dd>
    ...
    <pre class="prettyprint"><code>let type = y
  event.path.forEach(dir => {
    type = type.get(dir)
  })
  type === event.target // => true</code></pre>
...
<h4 class="name" id="target">
    <span class="type-signature"></span>target<span class="type-signature"> :<a href="AbstractType.html">AbstractType</a>.&lt;any></span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line23">line 23</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The type on which this event was created on.</p>
    </div>
...
<h4 class="name" id="transaction">
    <span class="type-signature"></span>transaction<span class="type-signature"> :<a href="Transaction.html">Transaction</a></span>
    
    <div class="container-source members">
        <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
        <code><a href="utils_YEvent.js.html#line33">line 33</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The transaction that triggered this event.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="adds">
                ...
                <span class="type-signature"></span>adds<span class="signature">(struct)</span><span class="type-signature"> &rarr; {boolean}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
                <code><a href="utils_YEvent.js.html#line78">line 78</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Check if a struct is added by this event.</p>
<p>In contrast to change.deleted, this method also returns true if the struct was added and then deleted.</p>
    </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>struct</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="AbstractStruct.html">AbstractStruct</a></span>
...
<dt>
        ...
        <h4 class="name" id="deletes">
            
                <span class="type-signature"></span>deletes<span class="signature">(struct)</span><span class="type-signature"> &rarr; {boolean}</span>
                
            
            <div class="container-source members">
                <code><a href="utils_YEvent.js.html">utils/YEvent.js</a></code>,
                <code><a href="utils_YEvent.js.html#line66">line 66</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Check if a struct is deleted by this event.</p>
<p>In contrast to change.deleted, this method also returns true if the struct was added and then deleted.</p>
    </div>
